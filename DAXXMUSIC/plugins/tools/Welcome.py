...
def welcomepic(pic, user, chat, id, uname):
    ...
    font = ImageFont.truetype('DAXXMUSIC/assets/font.ttf', size=63)
    font2 = ImageFont.truetype('DAXXMUSIC/assets/font.ttf', size=90)
    draw.text((85, 200), f'NAME: {unidecode(user)}', fill=(255, 0, 255), font=font)
    draw.text((85, 300), f'ID: {id}', fill=(255, 0, 255), font=font)
    draw.text((85, 400), f"USERNAME : {uname}", fill=(255,0,255),font=font)
    pfp_position = (720, 70)  
